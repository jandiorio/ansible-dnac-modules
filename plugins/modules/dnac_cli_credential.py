...
description:
  - Add or Delete Global CLI Credentials in Cisco DNA Center Controller. \
    These credentials can be created at any level in the hierarchy.\
    This module creates the credential at the specified level of hierarchy only.  * Assigning the \
    credential as active in the Design Workflow will be handled in the \
    dnac_assign_credential module.
version_added: "2.5"
